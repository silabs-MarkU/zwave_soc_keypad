...
void cli_get_doorhandle_state(sl_cli_command_arg_t *arguments);
void cli_get_doorbolt_state(sl_cli_command_arg_t *arguments);
void cli_get_doorlatch_state(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd__battery_report = \
  SL_CLI_COMMAND(cli_battery_report,
                 "Send battery report",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__enter_user_code = \
  SL_CLI_COMMAND(cli_enter_user_code,
                 "Enter a user code",
                  "Current user code" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_STRING, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__set_new_user_code = \
  SL_CLI_COMMAND(cli_set_new_user_code,
                 "Set a new user code",
                  "User code to be set" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_STRING, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__set_doorhandle_state = \
  SL_CLI_COMMAND(cli_set_doorhandle_state,
                 "Set door handle state to locked (1) or unlocked (0)",
                  "activate or deactivate" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_STRING, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__get_doorhandle_state = \
  SL_CLI_COMMAND(cli_get_doorhandle_state,
                 "Get door handle state",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__get_doorbolt_state = \
  SL_CLI_COMMAND(cli_get_doorbolt_state,
                 "Get door bolt state",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__get_doorlatch_state = \
  SL_CLI_COMMAND(cli_get_doorlatch_state,
                 "Get doorlatch state",
                  "",
                 {SL_CLI_ARG_END, });
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "battery_report", &cli_cmd__battery_report, false },
  { "enter_user_code", &cli_cmd__enter_user_code, false },
  { "set_new_user_code", &cli_cmd__set_new_user_code, false },
  { "set_doorhandle_state", &cli_cmd__set_doorhandle_state, false },
  { "get_doorhandle_state", &cli_cmd__get_doorhandle_state, false },
  { "get_doorbolt_state", &cli_cmd__get_doorbolt_state, false },
  { "get_doorlatch_state", &cli_cmd__get_doorlatch_state, false },
